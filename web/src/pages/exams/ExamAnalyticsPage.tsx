...
const ExamAnalyticsCharts = lazy(() => import("./ExamAnalyticsCharts"));
...
export default function ExamAnalyticsPage() {
  ...
  const knowledgePointRadarData = useMemo(() => {
  ...
  // 热力图数据 - 学生答题情况矩阵
  const heatmapMasteryData = useMemo(() => {
      ...
      <div className="space-y-8">
        {analytics ? (
          <div className="space-y-8">
            ...
            <Suspense
              fallback={<div className="text-sm text-ink-600">加载图表...</div>}
            >
              <ExamAnalyticsCharts
                scoreDistributionData={scoreDistributionData}
                questionTypeData={questionTypeData}
                difficultyData={difficultyData}
                knowledgePointRadarData={knowledgePointRadarData}
                boxPlotData={boxPlotData}
                scatterData={scatterData}
                histogramData={histogramData}
                knowledgePointTrendData={
                  analytics?.knowledgePointStats?.slice(0, 8) || []
                }
                heatmapMasteryData={heatmapMasteryData}
                heatmapMatrixData={heatmapMatrixData}
