          ...
          <div className="space-y-6">
            ...
            <div className="prose max-w-none">
              <p className="text-lg text-gray-700 mb-6">
                ExamForge
                是一个基于AI的智能考试系统，支持多种题型的自动导入、智能评分和数据分析。
              </p>
            ...
            <div className="prose max-w-none">
              ...
              <div className="bg-gray-50 p-4 rounded-lg mb-4">
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li>
                    <strong>通义千问 (Qwen)</strong> - 阿里云大语言模型
                  </li>
                  <li>
                    <strong>OpenAI GPT</strong> - OpenAI官方API
                  </li>
                  <li>
                    <strong>Claude</strong> - Anthropic AI助手
                  </li>
                  <li>
                    <strong>自定义API</strong> - 兼容OpenAI格式的其他服务
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg mt-4">
                <p className="text-yellow-800">
                  <strong>注意：</strong>AI
                  Provider用于智能评分主观题，如简答题、论述题等。客观题（选择题、判断题）会自动评分。
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="prose max-w-none">
              ...
              <div className="bg-orange-50 border border-orange-200 p-4 rounded-lg mt-4">
                <p className="text-orange-800">
                  <strong>建议：</strong>
                  对于重要考试，建议教师对AI评分进行人工复核，确保评分的准确性和公平性。
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="prose max-w-none">
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>
                  <strong>箱线图</strong> - 显示题目得分的统计分布
                </li>
                <li>
                  <strong>散点图</strong> - 分析题目难度与正确率关系
                </li>
                <li>
                  <strong>直方图</strong> - 详细的分数分布分析
                </li>
                <li>
                  <strong>热力图</strong> - 学生答题情况矩阵
                </li>
                <li>
                  <strong>趋势图</strong> - 知识点掌握趋势分析
                </li>
              </ul>
              ...
              <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg mt-4">
                <p className="text-blue-800">
                  <strong>提示：</strong>
                  统计分析功能帮助教师了解教学效果，识别学生薄弱环节，为后续教学提供数据支持。
                </p>
              </div>
            </div>
          </div>
